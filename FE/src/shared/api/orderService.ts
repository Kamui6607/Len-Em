// ============================================================
// Order Service â€” clean API wrapper for order endpoints
// ============================================================
...
export const orderApi = {
  /**
   * POST /orders/shipping-fee â€” preview shipping fee & totals
  ...
  /**
   * POST /orders â€” create a new order (customer)
  ...
  /**
   * GET /orders/my â€” get current customer's orders (paginated)
   */
  getMyOrders: (params?: { page?: number; limit?: number }) =>
    axiosClient.get<MyOrdersResponse>(`${ORDERS_BASE}/my`, { params }),

  /**
   * GET /orders/:id â€” get order detail (customer or admin/staff)
  ...
  /**
   * POST /orders/:id/cancel â€” customer requests cancel on their PENDING order
  ...
  /**
   * PATCH /orders/:id/cancel-request â€” admin approves/rejects cancel request
   * Body: { decision: "APPROVED" | "REJECTED" }
   * APPROVED â†’ order becomes CANCELLED + auto-creates RefundInvoice
   * REJECTED â†’ order stays PENDING, removes isCancelRequested flag
   */
  ...
  /**
   * POST /orders/:id/retry-payment â€” retry payment for cancelled/unpaid order
  ...
  /**
   * GET /orders â€” admin/staff get all orders with filters + pagination
   */
  getAllOrders: (params?: {
    page?: number;
    limit?: number;
  ...
  /**
   * PATCH /orders/:id/status â€” admin/staff update order status
   * Backend returns: { message, order }
   */
