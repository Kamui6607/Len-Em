// ============================================================
// Refund Invoice Service â€” API calls for refund management
// ============================================================
...
export const refundService = {
  /** GET /refund-invoices â€” Get all refund invoices (Admin only) */
  getAll: (params?: {
    page?: number;
    limit?: number;
    status?: string;
  ...
  /** PATCH /refund-invoices/{id}/process â€” Process a refund invoice (Admin only) */
