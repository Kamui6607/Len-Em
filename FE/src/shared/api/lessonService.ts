// ============================================================
// Lesson Service â€” all API calls related to lessons
// ============================================================
...
export const lessonService = {
  /** GET /lessons â€” Get all lessons (Admin & Staff, requires auth) */
  getAll: () =>
    axiosClient.get<ApiResponse<{ lessons: Lesson[] }>>(LESSONS_BASE),

  /** GET /lessons/{lessonId} â€” Get lesson detail (public if preview, auth required otherwise) */
