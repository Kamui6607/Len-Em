...
function LargeGiftBox({ size = 200 }: { size?: number }) {
  return (
    ...
    >
      ...
      {/* ══ RIBBON — vertical ══ */}
      <rect x="93" y="90" width="14" height="80" rx="3" fill="url(#lg-rib)" />
      {/* Ribbon shine */}
      <rect
        x="95"
        y="90"
      ...
      {/* ══ RIBBON — horizontal ══ */}
      <rect x="58" y="122" width="84" height="11" rx="3" fill="url(#lg-rib)" />
      {/* Ribbon shine */}
      <rect
        x="58"
        y="124"
      ...
      {/* ══ BOW — centre knot ══ */}
      <ellipse cx="100" cy="90" rx="9" ry="7" fill="var(--primary)" />
      <ellipse
        cx="100"
        cy="90"
        rx="4"
      ...
      <path
        d="M150,54 L152,47 L154,54 L161,56 L154,58 L152,65 L150,58 L143,56 Z"
        fill="var(--accent-yellow)"
        fillOpacity="0.95"
      />
      {/* Medium sparkle — top left */}
      <path
        d="M50,56 L51.5,51 L53,56 L58,57.5 L53,59 L51.5,64 L50,59 L45,57.5 Z"
        fill="var(--accent-pink)"
        fillOpacity="0.85"
      />
      {/* Small sparkle — right side */}
      <path
        d="M164,114 L165,110 L166,114 L170,115 L166,116 L165,120 L164,116 L160,115 Z"
        fill="var(--accent-yellow)"
        fillOpacity="0.75"
      />
      {/* Tiny sparkle — lower left */}
      <path
        d="M44,142 L45,138 L46,142 L50,143 L46,144 L45,148 L44,144 L40,143 Z"
        fill="var(--accent-pink)"
        fillOpacity="0.65"
      />
...
function PomPomShape({
  ...
  return (
    ...
    >
      ...
      <circle cx={r + fib} cy={r + fib} r={r} fill={color} opacity={opacity} />
      <circle
        cx={r + fib}
        cy={r + fib}
        r={r * 0.65}
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(ellipse, rgba(245,239,168,0.32) 0%, rgba(240,196,224,0.22) 40%, transparent 72%)",
            filter: "blur(40px)",
          }}
        />
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(ellipse, rgba(240,196,224,0.18) 0%, rgba(107,63,160,0.08) 55%, transparent 75%)",
            filter: "blur(55px)",
          }}
        />
      </div>
        ...
        <div style={{ position: "relative", marginBottom: "8px" }}>
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(ellipse at 50% 55%, rgba(245,239,168,0.55) 0%, rgba(240,196,224,0.38) 40%, transparent 70%)",
              filter: "blur(24px)",
              zIndex: 0,
            }}
          />
