// ============================================================
// AdminDIYPosts — route /admin/diy-posts
// Admin quản lý tất cả DIY posts
// ============================================================
...
import { CheckCircle, XCircle, Eye, Trash2, ChevronUp, ChevronDown, Check } from "lucide-react";
                    ...
                    <tr key={post._id} className="border-b border-border hover:bg-[var(--surface-secondary)] transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`badge ${
                          post.status === "pending" ? "badge-orange" :
              ...
              {posts.map((post) => (
                <div key={post._id} className="p-4 rounded-xl border border-border bg-surface">
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    #{post._id.slice(-8)} • {format(new Date(post.createdAt), "MMM dd, yyyy")}
                  </p>
                  <button onClick={() => setSelectedPost(post)} className="text-primary hover:underline text-xs">
                    View Details
                  </button>
                </div>
              ))}
          ...
          >
            ...
            <div className="admin-dialog-body">
              <p className="text-sm text-muted-foreground">
                Are you sure you want to delete post <strong className="text-foreground">"{postToDelete.title}"</strong>? 
          ...
          >
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                   <span className={`badge ${
                     selectedPost.status === "pending" ? "badge-orange" :
                     selectedPost.status === "approved" ? "badge-green" :
                     "badge-red"
                   }`}>
                     {selectedPost.status}
                   </span>
            ...
            <div className="admin-dialog-body">
              ...
              <div>
                ...
                <p className="text-sm">
                  {format(new Date(selectedPost.createdAt), "MMM dd, yyyy HH:mm")}
                </p>
              </div>
